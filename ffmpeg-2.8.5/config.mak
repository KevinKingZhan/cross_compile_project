...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --disable-shared --disable-asm --disable-yasm --enable-filter=aresample --enable-bsf=aac_adtstoasc --enable-small --enable-dct --enable-dwt --enable-lsp --enable-mdct --enable-rdft --enable-fft --enable-static --enable-version3 --enable-nonfree --enable-encoder=pcm_s16le --enable-encoder=aac --enable-encoder=libvo_aacenc --enable-encoder=libfdk_aac --enable-encoder=mp2 --enable-encoder=libx264 --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=pcm_s16le --enable-decoder=h264 --enable-parser=aac --enable-muxer=flv --enable-muxer=mp4 --enable-muxer=wav --enable-muxer=adts --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=wav --disable-decoder=h264_vda --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-securetransport --enable-demuxer=aac --enable-demuxer=hls --enable-protocol=rtmp --enable-protocol=file --enable-libx264 --enable-libvo-aacenc --enable-libfdk_aac --enable-libmp3lame --extra-cflags='-Ipcvoaac/include -Ipc_fdk_aac/include -Ix264_pc/include -Ipc_lame/include' --extra-ldflags='-Lpcvoaac/lib -Lpc_fdk_aac/lib -Lx264_pc/lib -Lpc_lame/lib' --prefix=/Users/xiaokai.zhan/book/workspace/cross_compile_project/ffmpeg-2.8.5/install-path
...
CFLAGS=  -Ipcvoaac/include -Ipc_fdk_aac/include -Ix264_pc/include -Ipc_lame/include -std=c99 -fomit-frame-pointer -fPIC -pthread -D_GNU_SOURCE=1 -D_THREAD_SAFE -I/usr/local/include/SDL -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -Ipcvoaac/include -Ipc_fdk_aac/include -Ix264_pc/include -Ipc_lame/include -fPIC -g -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -Lpcvoaac/lib -Lpc_fdk_aac/lib -Lx264_pc/lib -Lpc_lame/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -liconv -L/usr/local/lib -lSDLmain -lSDL -Wl,-framework,Cocoa -lx264 -lvo-aacenc -lmp3lame -lfdk-aac -framework CoreGraphics -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
