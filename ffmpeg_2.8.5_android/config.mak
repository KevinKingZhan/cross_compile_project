...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-gpl --disable-shared --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-avdevice --disable-indevs --disable-devices --disable-debug --disable-asm --disable-yasm --disable-doc --disable-bsfs --disable-ffplay --disable-ffprobe --disable-ffserver --disable-indevs --disable-outdevs --enable-cross-compile --cross-prefix=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --enable-filter=aresample --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-small --enable-dct --enable-dwt --enable-lsp --enable-mdct --enable-rdft --enable-fft --enable-static --enable-version3 --enable-nonfree --disable-encoders --enable-encoder=pcm_s16le --enable-encoder=aac --enable-encoder=libmp3lame --enable-encoder=libvo_aacenc --enable-encoder=libfdk_aac --enable-encoder=libx264 --enable-encoder=mp2 --disable-decoders --enable-decoder=aac --enable-decoder=mjpeg --enable-decoder=png --enable-decoder=gif --enable-decoder=mp3 --enable-decoder=h264 --enable-decoder=pcm_s16le --disable-parsers --enable-parser=mjpeg --enable-parser=png --enable-parser=aac --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=mpegaudio --disable-muxers --enable-muxer=avi --enable-muxer=flv --enable-muxer=mp4 --enable-muxer=m4v --enable-muxer=mp3 --enable-muxer=mov --enable-muxer=h264 --enable-muxer=wav --enable-muxer=adts --disable-demuxers --enable-demuxer=mjpeg --enable-demuxer=m4v --enable-demuxer=gif --enable-demuxer=mov --enable-demuxer=avi --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=wav --disable-protocols --enable-protocol=rtmp --enable-protocol=file --enable-protocol=http --disable-filters --enable-filter=transpose --enable-filter=crop --enable-filter=vflip --enable-filter=hflip --enable-libx264 --enable-libvo-aacenc --enable-libfdk_aac --enable-libmp3lame --sysroot=/Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm --extra-cflags='-marm -march=armv7-a -I/Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm/usr/include -Iexternal_libs/vo_aac/build/armv5/include -Iexternal_libs/fdk-aac/build/armv7a/include -Iexternal_libs/libx264/build/armv7a/include -Iexternal_libs/lame/build/armv7a/include' --extra-ldflags='-marm -march=armv7-a -Lexternal_libs/vo_aac/build/armv5/lib -Lexternal_libs/fdk-aac/build/armv7a/lib -Lexternal_libs/libx264/build/armv7a/lib -Lexternal_libs/lame/build/armv7a/lib' --prefix=/Users/xiaokai.zhan/book/workspace/cross_compile_project/ffmpeg_2.8.5_android/build/armv7a
prefix=/Users/xiaokai.zhan/book/workspace/cross_compile_project/ffmpeg_2.8.5_android/build/armv7a
...
ARCH=c
INTRINSICS=none
CC=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
CXX=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
LD=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm -isysroot /Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -marm -march=armv7-a -I/Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm/usr/include -Iexternal_libs/vo_aac/build/armv5/include -Iexternal_libs/fdk-aac/build/armv7a/include -Iexternal_libs/libx264/build/armv7a/include -Iexternal_libs/lame/build/armv7a/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -marm -march=armv7-a -I/Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm/usr/include -Iexternal_libs/vo_aac/build/armv5/include -Iexternal_libs/fdk-aac/build/armv7a/include -Iexternal_libs/libx264/build/armv7a/include -Iexternal_libs/lame/build/armv7a/include -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/Users/xiaokai.zhan/soft/android-ndk-r10d/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -marm -march=armv7-a -Lexternal_libs/vo_aac/build/armv5/lib -Lexternal_libs/fdk-aac/build/armv7a/lib -Lexternal_libs/libx264/build/armv7a/lib -Lexternal_libs/lame/build/armv7a/lib  --sysroot=/Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm -isysroot /Users/xiaokai.zhan/soft/android-ndk-r10d/platforms/android-9/arch-arm -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lx264 -lvo-aacenc -lmp3lame -lfdk-aac -lm -lz -pthread 
